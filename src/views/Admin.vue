<template>
    <div class="relative flex h-screen min-w-screen">
        <!-- Sidebar -->
        <div class="overflow-hidden bg-gradient-to-b from-orange-800 to-orange-300 w-64 space-y-6 px-2 py-4 absolute inset-y-0 left-0 md:relative md:-translate-x-0 transform -translate-x-full transition duration-200 ease-in-out"
