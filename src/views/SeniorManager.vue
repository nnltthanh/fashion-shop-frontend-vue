<template>
    <div class="relative flex h-screen min-w-screen">
        <!-- Sidebar -->
        <div class="overflow-hidden bg-gradient-to-b from-green-800 to-green-300 w-64 space-y-6 px-2 py-4 absolute inset-y-0 left-0 md:relative md:-translate-x-0 transform -translate-x-full transition duration-200 ease-in-out"
            ...
            <div
                ...
                <span class="text-[15px] ml-4 text-gray-200 font-bold">Quản lý khuyến mãi</span>
            </div>
            <div
                class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-green-600 text-white">
                <i class="bi bi-bookmark-fill"></i>
                <span class="text-[15px] ml-4 text-gray-200 font-bold">Quản lý bảng tin</span>
            </div>
            <div
                class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-green-600 text-white">
                <i class="bi bi-house-door-fill"></i>
                <span class="text-[15px] ml-4 text-gray-200 font-bold">Thống kê báo cáo</span>
            </div>
        ...
        <div class="flex-1 overflow-hidden">
            ...
            <div class="grid justify-items-stretch bg-white shadow px-2 py-4">
                <div class="flex justify-between">
                    ...
                    <div class="font-bold text-4xl animate-gradient py-2">TRANG QUẢN LÝ CẤP CAO
                    </div>
                    <div></div>
                </div>
            </div>
...
import PersonalInformation from '@/components/senior-manager/PersonalInformation.vue';
...
onBeforeMount(() => {
    ...
    const storedAccount = localStorage.getItem('accountSeniorManager');
    if (storedAccount) {
...
const logOut = () => {
    localStorage.removeItem('accountSeniorManager');
