    ...
    <div class="cart-item-thumbnail">
      <div class="cart-item-thumbnail-image">
        <div class="cart-item-thumbnail-block">
          <img
            src="https://media.coolmate.me/cdn-cgi/image/width=320,height=362,quality=80/uploads/April2022/DSC05753_copy1.jpg"
            alt="Quà tặng - Áo thun thể thao nam ProMax-S1"
            style="opacity: 1"
          />
          <div class="cart-item-multiselect">
            <label
              for="select6294598ce8aeb331620851301c6ee7f6"
              class="custom-checkbox-label custom-cursor-on-hover"
              ><span class="custom-checkbox"
                ><input
                  type="checkbox"
                  id="select6294598ce8aeb331620851301c6ee7f6" />
      ...
      <div class="cart-item-content-wrapper">
        <div class="cart-item-content-inner" style="opacity: 1">
          ...
          <h3 class="cart-item-title">
            <a
              ...
              target="_blank"
              >Quà tặng - Áo thun thể thao nam ProMax-S1</a
            >
          </h3>
          <div class="cart-item-variant">Xanh Aqua / L</div>
        </div>
        <div class="cart-item-actions" style="opacity: 1">
          <div class="cart-item-selects">
            ...
            >
              <div
                ...
                role="combobox"
                aria-expanded="false"
                aria-owns="vs18-listbox"
                aria-label="Search for option"
                class="vs-dropdown-toggle"
              >
                <div class="vs-selected-options">
                  <span class="vs-selected"> Xanh Aqua</span>
                  <input
                    readonly="false"
                    aria-autocomplete="list"
                    aria-labelledby="vs18-combobox"
                    aria-controls="vs18-listbox"
                    type="search"
                    autocomplete="off"
                    class="vs-search"
                  />
              ...
              >
                <div class="vs-selected-options">
                  ...
                  <input
                    readonly="false"
                    aria-autocomplete="list"
                    aria-labelledby="vs19-combobox"
                    aria-controls="vs19-listbox"
                    type="search"
                    autocomplete="off"
                    class="vs-search"
                  />
          ...
          <div class="cart-item-quantity">
            <span class="cart-item-quantity-number">x1</span>
          </div>
