  ...
  <div class="cart-item">
    <div class="cart-item-thumbnail">
      <div class="cart-item-thumbnail-image">
        <div class="cart-item-thumbnail-block">
          <img
            src="https://media.coolmate.me/cdn-cgi/image/width=320,height=362,quality=80/uploads/December2023/boxer_short_ke_00016_copy.jpg"
          ...
          <div class="cart-item-multiselect">
            <label
              for="select6583e98f952d32683c32a758aeb6e386"
              class="custom-checkbox-label"
              ><span class="custom-checkbox"
                ><input
                  type="checkbox"
                  id="select6583e98f952d32683c32a758aeb6e386" />
    ...
    <div class="cart-item-content">
      <div class="cart-item-content-wrapper">
        <div class="cart-item-content-inner" style="opacity: 0.5">
          <!---->
          <!---->
          <h3 class="cart-item-title">
            <a
              href="/product/pack-3-quan-short-nam-boxer-ke-soc-thoang-mat"
              target="_blank"
              >Pack 3 Quần Shorts Nam kẻ sọc Basics</a
            >
          </h3>
          <div class="cart-item-variant">Mix màu / 3XL</div>
        </div>
        <div class="cart-item-actions" style="opacity: 0.5">
          <div class="cart-item-selects">
            ...
            >
              <div
                ...
                role="combobox"
                aria-expanded="false"
                aria-owns="vs6-listbox"
                aria-label="Search for option"
                class="vs-dropdown-toggle"
              >
                <div class="vs-selected-options custom-cursor-on-hover">
                  <span class="vs-selected">
                    Mix màu
                    <!----></span
                  >
                  <input
                    ...
                    aria-labelledby="vs6-combobox"
                    aria-controls="vs6-listbox"
                    type="search"
                    autocomplete="off"
                    class="vs-search"
                  />
              ...
              >
                <div class="vs-selected-options">
                  ...
                  <input
                    readonly="true"
                    aria-autocomplete="list"
                    aria-labelledby="vs7-combobox"
                    aria-controls="vs7-listbox"
                    type="search"
                    autocomplete="off"
                    class="vs-search"
                  />
