                        ...
                        <div class="product-single__thumbnails">
                            <div class="product-single__inner">
                                <div class="thumbnails">
                                    <a href="#" class="image">
                                        <img src="https://media.coolmate.me/cdn-cgi/image/format=auto/uploads/January2024/23CMAW.TT004.1.jpg"
                    ...
                    <div class="product-single__summary">
                        <div class="product-single__sticky">
                            <h1 class="product-single__title">
                                Áo Singlet Nam Chạy Bộ in Graphic Special
                            ...
                            <div class="product-single__price-infomation">
                                <div class="product-single__prices">
                                    <ins class="product-single__regular-price">189.000đ</ins>
                                </div>
                            </div>
